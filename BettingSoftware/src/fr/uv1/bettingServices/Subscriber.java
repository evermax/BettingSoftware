...
public class Subscriber implements Serializable {
    ...
    /**
     * Constructeur de Subscriber utilisé par SubscriberDAO permettant
     * d'affecter l'id
     */
    ...
    /**
     * Fonction permettant de asvoir si le joueur participe une compétition
     * 
     * @param comp
     *            compétition à laquelle on souhaite savoir si le joueur
     *            participe ou non
     * @return true si la compétition comp possède un participant avec les mêmes
     *         nom, prénom et date de naissance, false sinon
    ...
    /**
     * Crédite au joueur le nombre de jetons numberTokens
     * 
     * @param numberTokens
     *            nombre de jetons à créditer
     * @throws BadParametersException
     *             si le nombre de jetons donné est négatif
     */
    ...
    /**
     * Débite au joueur le nombre de jetons numberTokens
     * 
     * @param numberTokens
     *            nombre de jetons à débiter
     * @throws BadParametersException
     *             si le nombre de jetons est négatif
     * @throws SubscriberException
    ...
    /**
     * Fonction permettant d'authentifier le joueur à l'aide de son mot de passe
     * 
     ...
     *             joueur
     * @throws BadParametersException
     *             si le nouveau mot de passe ne respecte pas les critère pour
     *             le mot de passe
     */
