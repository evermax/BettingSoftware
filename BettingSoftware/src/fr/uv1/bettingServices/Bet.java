...
public class Bet {
     ...
     */
    public Bet(long tokenNumber, Subscriber subscriber,
            Competition competition, Competitor winner) {
    ...
    public Bet(Integer id, long tokenNumber, Subscriber subscriber,
            Competition competition, Competitor winner) {
     ...
     */
    public Bet(long tokenNumber, Subscriber subscriber,
            Competition competition, Competitor winner, Competitor second,
            Competitor third) {
        this(tokenNumber, subscriber, competition, winner);
        this.second = second;
        this.third = third;
    ...
    public Bet(Integer id, long tokenNumber, Subscriber subscriber,
            Competition competition, Competitor winner, Competitor second,
            Competitor third) {
        this(tokenNumber, subscriber, competition, winner, second, third);
        this.id = id;
    }
