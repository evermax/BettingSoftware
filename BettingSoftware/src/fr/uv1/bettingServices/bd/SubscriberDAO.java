...
public class SubscriberDAO {
    ...
    public static void changeTokens(Subscriber s, long tokens)
            throws SQLException {
        Connection c = DataBaseConnection.getConnection();
        PreparedStatement psUpdateToken = c
                .prepareStatement("update subscriber set tokens = tokens + ? where idSubscriber = ?");
