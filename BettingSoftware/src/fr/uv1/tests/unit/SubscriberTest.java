...
public class SubscriberTest {
    ...
    public void testNullLastnameSubscriber() throws BadParametersException,
        ...
        new Subscriber(null, new String("Miguel"), new String("worldChamp"),
                new GregorianCalendar(1991, 06, 31));
    }
    ...
    @Test(expected = BadParametersException.class)
    public void testInvalidsetLastname() throws BadParametersException,
            SubscriberException {
        subs = new Subscriber(new String("Duran"), new String("Miguel"),
                new String("worldChamp"), new GregorianCalendar(1991, 06, 31));
    ...
    @Test(expected = BadParametersException.class)
    public void testInvalidSetFirstname() throws BadParametersException,
            SubscriberException {
        subs = new Subscriber(new String("Duran"), new String("Miguel"),
                new String("worldChamp"), new GregorianCalendar(1991, 06, 31));
    ...
    @Test(expected = BadParametersException.class)
    public void testNullSetUsername() throws BadParametersException,
            SubscriberException {
        subs = new Subscriber(new String("Duran"), new String("Miguel"),
                new String("worldChamp"), new GregorianCalendar(1991, 06, 31));
    ...
    @Test(expected = BadParametersException.class)
    public void testInvalidSetUsername() throws BadParametersException,
            SubscriberException {
        subs = new Subscriber(new String("Duran"), new String("Miguel"),
                new String("worldChamp"), new GregorianCalendar(1991, 06, 31));
    ...
    @Test
    public void testCrediterSoldeJetons() throws SubscriberException,
    ...
    @Test(expected = BadParametersException.class)
    public void testInvalidCrediterSoldeJetons() throws SubscriberException,
            BadParametersException {
        subs = new Subscriber(new String("Duran"), new String("Miguel"),
                new String("worldChamp"), new GregorianCalendar(1991, 06, 31));
    ...
    @Test
    public void testDebiterSoldeJetons() throws SubscriberException,
            BadParametersException {
        subs = new Subscriber(new String("Duran"), new String("Miguel"),
                new String("worldChamp"), new GregorianCalendar(1991, 06, 31));
    ...
    @Test(expected = BadParametersException.class)
    public void testInvalidDebiterSoldeJetons() throws SubscriberException,
            BadParametersException {
        subs = new Subscriber(new String("Duran"), new String("Miguel"),
                new String("worldChamp"), new GregorianCalendar(1991, 06, 31));
    ...
    public void testInsuffisantDebiterSoldeJetons() throws SubscriberException,
            BadParametersException {
        subs = new Subscriber(new String("Duran"), new String("Miguel"),
                new String("worldChamp"), new GregorianCalendar(1991, 06, 31));
